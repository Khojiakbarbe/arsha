        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content" data-aos="fade-left" data-aos-delay="100">
            ...
            <div class="skills-content">
              <?php while ($data = $pdoStatement->fetch()) { ?>
                <div class="progress">
                  <span class="skill">
                    <?= $data['skill'] ?> <i class="val">
                      <?= $data['knowladge'] ?>
                    </i>
                  </span>
                  <div class="progress-bar-wrap">
                    <div class="progress-bar" style="background-color: <?= $data['color'] ?>;" role="progressbar"
                      aria-valuenow="<?= intval($data['knowladge']) ?>" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                </div>
              <?php } ?>
            </div>
